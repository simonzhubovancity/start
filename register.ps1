...
.\config.cmd --deploymentgroup --deploymentgroupname "sbzvsphere-DEV" --agent $env:COMPUTERNAME --runasservice --work '_work' --url 'https://dev.azure.com/Vancity/' --projectname 'Vancity' --auth PAT --token "REPLACEME" 
